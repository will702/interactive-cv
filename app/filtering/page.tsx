...
import { ConvAnimation } from '@/components/interactive/ConvAnimation';
import { KernelEditor } from '@/components/interactive/KernelEditor';
import { ImageUploader } from '@/components/interactive/ImageUploader';
import { ImageCompare } from '@/components/interactive/ImageCompare';
import { BlockMath, InlineMath } from 'react-katex';
import { KERNELS, ASYMMETRIC_KERNEL } from '@/lib/kernels';
import { applyKernel, convVsCorr } from '@/lib/api';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-24 pb-20">
      ...
      <LessonSection title="The Anatomy of Convolution">
        ...
        <p className="mt-8">
          The mathematical operation for a kernel <InlineMath math="H" /> and image <InlineMath math="I" /> at pixel <InlineMath math="(x, y)" /> is expressed as:
        </p>
        <div className="my-10 bg-[#F9F8F6] p-10 rounded-sm border border-slate-200/60 shadow-inner relative overflow-hidden">
          <div className="relative z-10">
            <BlockMath math="(I * H)[x, y] = \sum_{i=-k}^k \sum_{j=-k}^k I[x-i, y-j] \cdot H[i, j]" />
          </div>
      ...
      <LessonSection title="Correlation vs. Convolution">
        <div className="space-y-8">
          <p>
            ...
            and vertically (<InlineMath math="180^\circ" /> rotation) before sliding it over the image.
          </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#F9F8F6] p-6 border border-slate-200/60 flex flex-col items-center gap-6">
                 ...
                 <div className="text-center">
                    <BlockMath math={cvcKernelName === 'Asymmetric Shift' 
