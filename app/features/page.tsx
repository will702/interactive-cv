...
import { HarrisDemo } from '@/components/interactive/HarrisDemo';
import { FeatureMatching } from '@/components/interactive/FeatureMatching';
import { HomographyDemo } from '@/components/interactive/HomographyDemo';
    ...
    <div className="max-w-4xl mx-auto space-y-24 pb-20">
      <div className="text-center space-y-6 pt-12">
        <div className="flex items-center justify-center gap-4 mb-2">
           ...
           <span className="text-[10px] font-sans font-bold text-slate-300 uppercase tracking-[0.4em]">Volume I // Part 02</span>
           <div className="h-px w-8 bg-slate-200" />
        </div>
