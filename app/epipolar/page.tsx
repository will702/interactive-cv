...
import { EpipolarDemo } from '@/components/interactive/EpipolarDemo';
import { TriangulationViewer } from '@/components/interactive/TriangulationViewer';
import { TriangulationLab } from '@/components/interactive/TriangulationLab';
...
export default function EpipolarPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-24 pb-20">
      ...
      <LessonSection title={<>Spatial Reconstruction via <InlineMath math="E" /></>}>
        <p className="text-lg">
